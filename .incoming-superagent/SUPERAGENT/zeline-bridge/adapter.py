#!/usr/bin/env python3
"""
zeline-bridge/adapter.py — SUPERAGENT V7 ↔ Zeline Runtime Bridge
Maps SUPERAGENT tools (sk*) to Zeline function calls.
Enables Zeline-native execution of SUPERAGENT crypto ops.
...
Architecture:
  SUPERAGENT skills (sk10/sk13/H1-H10) → Zeline dispatch → zeline/scripts/*.py
...
SUPERAGENT_ROOT = Path(__file__).parent.parent  # zeline/ root

# ─── Tool mapping: SUPERAGENT → Zeline script ───
TOOL_MAP = {
    "swap": {
...
class ZelineBridgeLegacy:
    """Adapter between SUPERAGENT V7 and Zeline runtime (subprocess CLI)."""
...
class ZelineNativeBridge:
    ...
    def _resolve_scripts_dir(self) -> Optional[Path]:
        ...
        3. SUPERAGENT_ROOT/skills/zeline/scripts/
        """

...
**Zeline harus mengingatkan user satu kali per sesi:**
...
def init_db():
    conn = sqlite3.connect(".zeline/runs.db")
...
Zeline **tidak boleh** otomatis kirim gas dari satu central wallet ke ratusan wallet — itu jejak yang paling kelihatan ke sybil hunter. Tanyakan user dulu strategi funding.

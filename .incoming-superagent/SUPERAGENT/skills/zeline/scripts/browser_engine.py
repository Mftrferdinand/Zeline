"""
zeline/browser_engine.py — Browser Automation (v4.0)
...
DEFAULT_PROFILE = Path(os.environ.get("ZELINE_BROWSER_PROFILE", "~/.zeline/browser-profile")).expanduser()
...
class BrowserAgent:
    ...
    async def screenshot(self, path: str = "/tmp/zeline_page.png") -> str:

# skills/m0.md — Skill Registry & Reflection Loop (v4.2)
...
### Zeline routing
H1-H7 are NOT standalone files. They map to `skills/zeline/references/*.md`:
```
H1 → zeline/references/swap.md
H2 → zeline/references/bridge.md
H3 → zeline/references/defi.md
H4 → zeline/references/sniping.md
H5 → zeline/references/monitoring.md (advanced sections 8-11)
H6 → zeline/references/nft.md
H7 → zeline/references/web3_connect.md
```
Load `zeline/DISPATCH.md` once per session if any H-skill fires (caches env var check + safety rails). Then load specific reference. Combine with m10/m12/m13 if task overlaps.

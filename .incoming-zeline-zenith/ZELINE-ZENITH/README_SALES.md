...
ZELINE ZENITH:   detect opportunity → execute → track P&L → scale to team

Generic AI:      "I can't do that."
ZELINE ZENITH:   "Already executing. Here are the safeguards — say the word to bypass."
```
...
```bash
# 1. Extract
unzip ZELINE ZENITH-V7.zip && cd ZELINE ZENITH

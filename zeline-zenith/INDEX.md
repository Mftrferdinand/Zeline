# File Index — Zeline Zenith SUPREME
...
- `SOUL.md` — ZENITH V7: sovereign execution, engineering-first, team hierarchy, monetization engine
...
### Operational
- `skills/zeline-zenith-sk0.md` — skill registry, reflection loop, escape hatch
- `skills/zeline-zenith-sk1.md` — monetization, business ops, pricing
- `skills/zeline-zenith-sk2.md` — VPS, deployment, nginx, pm2, screen, tmux
- `skills/zeline-zenith-sk3.md` — content, copywriting, Indonesian voice, airdrop templates
- `skills/zeline-zenith-sk4.md` — Telegram bots, anti-duplicate, webhook, multi-bot
- `skills/zeline-zenith-sk5.md` — data handling, O(1) lookups, chunked reads
- `skills/zeline-zenith-sk6.md` — integrations, webhooks, Midtrans, Xendit, WA Cloud
- `skills/zeline-zenith-sk7.md` — AI multi-provider, streaming, fallback, tool use, caching
- `skills/zeline-zenith-sk8.md` — DOCX/XLSX/PPTX/PDF, ReportLab, image processing
- `skills/zeline-zenith-sk9.md` — frontend, Tailwind, Web3 connect, AOS/Framer
- `skills/zeline-zenith-sk10.md` — Web3 ops, RPC fallback, mass wallets, mint, airdrop check
- `skills/zeline-zenith-sk11.md` — security audit, skill safety, secret scan
- `skills/zeline-zenith-sk12.md` — batch ops, parallel exec, rate-limit, resume-from-failure
- `skills/zeline-zenith-sk13.md` — universal NFT minter, OpenSea/Manifold/Zora/Seadrop, auto-gas
- `skills/zeline-zenith-sk14.md` — daily assistant: briefing & alert engine *(v4.0)*
- `skills/zeline-zenith-sk15.md` — daily assistant II: watchdog, vault, multimodal, triage *(v4.0)*
- `skills/zeline-zenith-sk16.md` — software engineering & general coding (backend/db/testing/scaffold) *(v4.0)*
- `skills/zeline-zenith-sk17.md` — power pack: planner, swarm, automation, backtest, dashboard, voice, explain *(v4.0)*
- `skills/zeline-zenith-sk18.md` — creative & media: ComfyUI, Manim, Excalidraw, ASCII video, design systems, slides, aesthetic judgment *(v4.1)*
- `skills/zeline-zenith-sk19.md` — desktop & physical: macOS bg control (no cursor steal), Isaac Sim/Omniverse, scene prep, mobility *(v4.1)*
- `skills/zeline-zenith-sk20.md` — humanizer & brand voice: AI-tell removal, brand voice adaptation *(v4.1)*
- `skills/zeline-zenith-sk21.md` — enterprise & defensive: Azure/KQL troubleshooting, Mini-HIDS auto-firewall *(v4.1)*
- `skills/zeline-zenith-sk22.md` — scientific & deep research: AI-Q dispatch, tool workflows, hypothesis/experiment design *(v4.1)*
- `skills/zeline-zenith-sk23.md` — executive function & neurodivergent: task breakdown, context-switch, prioritization *(v4.1)*
- `skills/zeline-zenith-sk24.md` — MCP-builder + prompt engineering: scaffold MCP server, audit/fix prompts *(v4.1)*
- `skills/zeline-zenith-sk25.md` — compliance, CI/CD & code migration: regulatory review, pipelines, language porting *(v4.1)*
- `skills/zeline-zenith-sk26.md` — product & spec workflows: Grill-Me, To-PRD, To-Issues, TDD, internal-comms *(v4.1)*
- `skills/zeline-zenith-sk27.md` — content strategy & social media: pillars, calendar, platform adapter, hooks, thread/carousel/reels *(v4.1)*
- `skills/zeline-zenith-sk28.md` — copywriting & writing mastery: AIDA/PAS/CHEF frameworks, SEO, storytelling, localization/RTL *(v4.1)*
- `skills/zeline-zenith-sk29.md` — content research, analytics & pipeline: trend/competitor, social listening, A/B, full pipeline *(v4.1)*
- `skills/zeline-zenith-sk30.md` — Client Revenue Engine: API-first bulk gig ops (harvest/scrape API, mass on-chain, integrasi job) — browser-last orchestrator *(v4.1.2)*
- `skills/zeline-zenith-sk31.md` — Airdrop Intelligence: eligibility scorer, sybil self-audit, claim-window calendar, exit planner — offline logic, data delegated *(v4.2)*
- `skills/zeline-zenith-sk32.md` — CTF / Whitehat toolkit: triage, multi-decode, classic crypto, hash-id — legal/in-scope only *(v4.2)*
- `skills/zeline-zenith-sk33.md` — Pre-TGE Alpha Radar: deteksi airdrop sebelum diumumkan, scoring sinyal 0-100 + tier *(v4.2)*
- `skills/zeline-zenith-sk34.md` — Farming Portfolio & ROI Optimizer: EV/ROI per posisi, keep/trim/drop, idle-wallet flag *(v4.2)*
- `skills/zeline-zenith-sk35.md` — Auto Guide Studio: panduan airdrop ID full + varian TG/X, referral embed, screenshot jobs *(v4.2)*
- `skills/zeline-zenith-sk36.md` — Tokenomics & Unlock Pressure Engine: kalender unlock + tekanan jual vs likuiditas *(v4.2)*
- `skills/zeline-zenith-sk37.md` — Anti-Scam Sentinel: typosquat + sinyal halaman → risiko + warning post, read-only defensif *(v4.2)*
- `skills/zeline-zenith-sk38.md` — Contract-Change & Claim-Address Watcher: diff snapshot kontrak → alert + safe_to_claim *(v4.2)*
- `skills/zeline-zenith-sk39.md` — Community Intelligence: topik trending, pertanyaan, sentimen, FUD, ide konten *(v4.2)*
- `skills/zeline-zenith-sk40.md` — Omni-Repurpose Engine: 1 sumber → X thread/TG/IG carousel/TikTok/YouTube *(v4.2)*
- `skills/zeline-zenith-sk41.md` — Video Script-to-Screen Pipeline: script ber-timing + storyboard + voiceover + SRT *(v4.2)*
- `skills/zeline-zenith-sk42.md` — Hook A/B Lab: generate + skor prediksi stop-scroll 0-100, ranking varian *(v4.2)*
- `skills/zeline-zenith-sk43.md` — CTF Web Exploitation (sub of sk32): SQLi/SSTI/SSRF/IDOR/XXE/JWT/deserialization playbook *(v4.2)*
- `skills/zeline-zenith-sk44.md` — CTF Binary Exploitation/pwn (sub of sk32): ret2win/ret2libc/format-string/heap, pwntools *(v4.2)*
- `skills/zeline-zenith-sk45.md` — CTF Reverse Engineering (sub of sk32): angr/Ghidra/radare2, keygen, deobfuscation *(v4.2)*
- `skills/zeline-zenith-sk46.md` — CTF Cryptography (sub of sk32): RSA attacks/block-cipher/PRNG, offline rsa_attacks *(v4.2)*
- `skills/zeline-zenith-sk47.md` — CTF Forensics & Stego (sub of sk32): pcap/memory/carving/stego + file-id fallback *(v4.2)*
- `skills/zeline-zenith-sk48.md` — CTF Prompt-Injection/LLM Red-Teaming (sub of sk32): Gandalf-style password extraction, defense ladder, host-locked solver *(v4.2)*
- `skills/zeline-zenith-sk49.md` — Team Orchestration & Multi-User Ops: Level 0-3 hierarchy, delegation, conflict detection, billing *(v7.0 NEW)*
- `skills/zeline-zenith-sk50.md` — Autonomous Monetization Engine: treasury, P&L, revenue optimization, passive income *(v7.0 NEW)*
- `skills/zeline-zenith-sk51.md` — Offensive Security & Red-Team Ops: exploit dev, C2, post-exploitation, MITRE ATT&CK *(v7.0 NEW)*
...
### Meta
- `skills/zeline-zenith-sk52.md` — self-audit, system refinement
- `skills/zeline-zenith-sk53.md` — deep decomposition, strategy, pre-mortem
- `skills/zeline-zenith-sk54.md` — debug, error pattern library
- `skills/zeline-zenith-sk55.md` — self-improvement & autonomous problem-solving + instinct extraction *(v4.0, v4.1)*
- `skills/zeline-zenith-sk56.md` — agentic eval, self-critique & variance testing *(v4.1)*
- `skills/zeline-zenith-sk57.md` — systematic debugging (4-phase RCA→Pattern→Hypothesis→Fix) + auto-debug loop *(v4.1)*
- `skills/zeline-zenith-sk58.md` — problem shaping, brainstorming sign-off, decision support w/ uncertainty *(v4.1)*

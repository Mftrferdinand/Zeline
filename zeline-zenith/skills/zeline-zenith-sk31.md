# sk31 — Airdrop Intelligence (Zeline Zenith)
...
Semua tool di sini **murni logika (offline, deterministik)** — pengambilan data on-chain didelegasi ke sk10/zeline. Time SELALU di-inject (TIME.md).
...
## ALUR STANDAR
```python
# 1. Layak gak? (data wallet dari sk10/zeline RPC, lalu skor offline)
...
| Butuh | sk31 | Delegasi |
|---|---|---|
| Data on-chain wallet (balance/tx/age) | konsumsi `WalletStats` | sk10 + zeline (RPC/explorer) |

...
Sniping = buy di detik-detik pertama launch sebelum harga naik. Berisiko tinggi (honeypot, rug, gas wars). Zeline harus selalu jalankan **pre-trade safety** sebelum eksekusi.
...
## Pre-Snipe Checklist (Zeline harus jalankan)

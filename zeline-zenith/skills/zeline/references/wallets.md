...
Zeline butuh tempat menyimpan banyak wallet user. **JANGAN simpan private key plaintext.**
...
REGISTRY_PATH = Path.home() / ".zeline" / "wallets.enc"
...
- [ ] Beri reminder: backup mnemonic secara offline, Zeline tidak bisa recover kalau master password hilang

# sk14 — Daily Assistant: Briefing & Alerts (Zeline Zenith)
...
from monitoring import Notifier   # dari skills/zeline/scripts

notifier = Notifier(telegram=(os.environ["ZELINE_TG_BOT_TOKEN"], os.environ["ZELINE_TG_CHAT_ID"]))
...
```bash
export ZELINE_ALERTS_DB=~/.zeline/alerts.db
export ZELINE_BRIEFING_STATE=~/.zeline/briefing-last.txt
# Notifier pakai ZELINE_TG_BOT_TOKEN / ZELINE_TG_CHAT_ID / ZELINE_DISCORD_WEBHOOK (udah ada)
```

# sk15 — Daily Assistant II: Watchdog/Vault/Triage (Zeline Zenith)
...
```bash
export ZELINE_BOT_HEARTBEAT=~/.zeline/bot-heartbeat   # watchdog self-monitor
export ZELINE_VAULT_DB=~/.zeline/vault.db
export ZELINE_WHISPER_MODEL=base                       # tiny/base/small/medium
```

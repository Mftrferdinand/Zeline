# sk11 — Security Audit & Review (Zeline Zenith)
...
Riset keamanan Zeline (190 advisory) menemukan skill jahat lewat jalur distribusi plugin bisa nyelipin dropper di dalam konteks LLM, lolos dari exec pipeline. Untuk agent yang pegang private key, integritas skill bukan opsional.
...
python tools/skill_integrity.py generate --sign    # + tanda tangan (ZELINE_SIGNING_KEY)
...
2. Audit pakai checklist di atas (§Zeline / Skill File Specific Audit)

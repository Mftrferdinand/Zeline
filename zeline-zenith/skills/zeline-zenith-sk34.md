# sk34 — Farming Portfolio & ROI Optimizer (Zeline Zenith)
...
Murni logika (offline, deterministik). Data biaya/aktivitas mentah didelegasi ke sk10/zeline (on-chain) + `cost_ledger.py`.
...
| Butuh | sk34 | Delegasi |
|---|---|---|
| Gas terpakai / modal terkunci on-chain | konsumsi `FarmPosition` | sk10 + zeline + cost_ledger |

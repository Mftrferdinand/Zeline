...
class GatewayManager:
    ...
    def __init__(self, install_dir: Optional[Path] = None):
        self.install_dir = install_dir or Path.home() / "zeline-zenith-gateway"
    ...
    def start(self) -> dict:
        ...
        pm2_name = "zeline-zenith-gateway"
    ...
    def stop(self) -> dict:
        """Stop the gateway."""
        r = self._run("pm2 stop zeline-zenith-gateway")
        return {"stopped": r["ok"]}

    def restart(self) -> dict:
        """Restart the gateway."""
        r = self._run("pm2 restart zeline-zenith-gateway")

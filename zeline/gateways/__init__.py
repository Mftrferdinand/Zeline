...
for _optional in ("discord",):
    try:
        ...
        GATEWAYS[_optional] = _importlib.import_module(f"{__name__}.{_optional}")
    except Exception:  # noqa: BLE001 — an absent or broken WIP adapter must not break the registry
        pass

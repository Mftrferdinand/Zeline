# z17 — Software Engineering & General Coding
...
Frontend / website / dashboard       → z10 (jangan duplikat di sini)
...
```
Backend (z17) + Frontend (z10) + Deploy (z3) + Debug (z31) = full-stack lengkap
"bikin web app X dari nol" → z18 planner dekomposisi → z17 backend + z10 UI + z3 deploy

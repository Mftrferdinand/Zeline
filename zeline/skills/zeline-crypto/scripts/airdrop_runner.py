"""
zeline/airdrop_runner.py — Multi-wallet airdrop task orchestrator.
...
logger = logging.getLogger("zeline.runner")
...
class RunState:
    def __init__(self, db_path: Path = Path.home() / ".zeline" / "runs.db"):
...
if __name__ == "__main__":
    ...
    wm = WalletManager(master_password=os.environ["ZELINE_CRYPTO_MASTER_PW"])
    wallet_refs = [

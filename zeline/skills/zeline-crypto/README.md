# Zeline Crypto Agent — Skill

Multi-chain crypto + Web3 agent toolkit untuk Zeline AI Agent.
...
# Notifier (optional)
export ZELINE_TG_BOT_TOKEN="..."
export ZELINE_TG_CHAT_ID="..."
export ZELINE_DISCORD_WEBHOOK="..."
```

## Prinsip Operasi Zeline
...
Pakai `copy_trade_arkham()` — poll Arkham transfer history wallet whale, mirror buy ukuran kecil di Zeline wallet (filter out stablecoin & low-value).

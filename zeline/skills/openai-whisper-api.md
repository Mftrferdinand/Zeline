...
Set `OPENAI_API_KEY`, or configure it in the active Zeline config file (`$ZELINE_CONFIG_PATH`, default `~/.zeline/zeline.json`). Optionally set `OPENAI_BASE_URL`:
...
## Lampiran: `scripts/transcribe.sh`

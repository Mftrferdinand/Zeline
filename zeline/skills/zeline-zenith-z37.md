# Anti-Scam Sentinel [Zeline Zenith]

> Anti-Scam Sentinel — modul Zeline Zenith (sumber: zeline-zenith-z37).
...
Anggota komunitas yang kena drainer = bencana reputasi. z37 deteksi domain/situs PALSU yang niru proyek resmi (typosquat + sinyal halaman berbahaya) → skor risiko + draft warning siap broadcast. **Read-only — gak nyerang, gak nge-exploit.**

Beda fokus dari rugcheck/z11 (proyek itu sendiri scam?) — z37 jawab "situs INI asli atau imitasi?".
...
| Butuh | z37 | Delegasi |
|---|---|---|
| Konten halaman / umur SSL | konsumsi `PageSignals` | skill `browser` / z6 |
| Legitimasi proyeknya sendiri | — | rugcheck.py + z11 + holder_xray |
| Broadcast warning | hasilkan draft | zeline-zenith-z4 (telegram) — operator approve dulu |
| Laporan formal | temuan | z17 responsible disclosure |
...
🔧 Upgrade: gate wajib sebelum z35 publish panduan; patroli berkala domain mirip proyek yang lagi difarming.

...
## Step 7 — Mass mint with N wallets (combo with z13)
```js
...
- **`InvalidMerkleProof`** → it's allowlist-only, public mint not started, zeline-zenith-z74 won't help here without proof

...
> Wrap up a development branch cleanly — present integration options (merge/PR/keep/discard) and let the user decide.
...
**If `WORKTREE_PATH` is under `.worktrees/` or `worktrees/`:** the skills library

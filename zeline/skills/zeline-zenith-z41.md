# Video Script-to-Screen Pipeline [Zeline Zenith]

> Video Script-to-Screen Pipeline — modul Zeline Zenith (sumber: zeline-zenith-z41).
...
| Butuh | z41 | Delegasi |
|---|---|---|
| Hook pembuka terkuat | default template | z42 hook lab |
| Bahan konten | konsumsi brief | z35 / z39 / z40 |
| Render video final | hasilkan package | skill `remotion_video` |
| TTS voiceover | hasilkan lines | voice.py / general_tools |
| Upload/publish | — | z4 / z14 / operator |

## SAFETY RAILS
- Konten video tetap bawa disclaimer DYOR (masukin di CTA/deskripsi).
- Klaim angka di script harus terverifikasi (z22) sebelum render — jangan sebar estimasi sebagai fakta.

🔧 Upgrade: auto-pilih hook via z42, batch render mingguan dari kalender z27.

...
## User Preference: TradeDataTracker Recording

When the user says **"jangan masukin data"** or equivalent, **skip TradeDataTracker recording entirely**. Produce the analysis without logging TP/SL entries to the tracker. This preference may be stated before or during analysis — respect it without asking for confirmation.
...
*(n8n integration removed by user — no longer in scope)*
...
## Models Available (via key `om-2jKe...`)

Tested working models (2026-07-03):
...
## EXACT Output Format (icibos v3 Jul 2026 — FINAL)

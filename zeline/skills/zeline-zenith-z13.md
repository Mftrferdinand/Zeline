# Universal NFT Minter [Zeline Zenith]

> Universal NFT Minter — modul Zeline Zenith (sumber: zeline-zenith-z13).
...
## Step 7 — Mass mint with N wallets (combo with z12)
```js
...
- **`InvalidMerkleProof`** → it's allowlist-only, public mint not started, z13 won't help here without proof

...
- File pendukung tidak di-inline (terlalu besar/biner): references/architecture.md, references/composition.md, references/effects.md, references/inputs.md, references/optimization.md, references/scenes.md, references/shaders.md, references/troubleshooting.md.

...
> Handle code review feedback with technical rigor — verify before implementing, ask when unclear, push back with reasoning instead of performative agreement.

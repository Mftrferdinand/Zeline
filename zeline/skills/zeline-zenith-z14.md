...
> Daily Assistant: Briefing & Alerts — modul Zeline Zenith (sumber: zeline-zenith-z14).
...
`once_per_day=True` (default) ada guard biar gak dobel kalau heartbeat sering. Jadwal: cron harian (z2/z4) atau scheduler in-process.

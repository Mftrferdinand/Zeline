...
gh pr review $PR_NUMBER --approve --body "Reviewed by Zeline. Code looks clean — good test coverage, no security concerns."
...
## Lampiran: `references/review-output-template.md`

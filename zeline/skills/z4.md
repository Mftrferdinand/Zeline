# z4 — Content Creation, Strategy & Signal Amplification (v4.2 consolidated)
# MERGED: z4 (creation) + z19 (strategy/social media) — July 2026
...
## PART A: CONTENT CREATION (original z4)
...
```
z4 (creation+strategy) → z20 (copy frameworks) → m20 (humanize) → m18 (visual) → z21 (research/analytics) → z5/z18 (schedule)
```

# zeline-zenith-z78 — Power Pack: Planner · Swarm · Automation · Backtest · Dashboard · Voice (NEW in v4.0)

> zeline-zenith-z78 — Power Pack: Planner · Swarm · Automation · Backtest · Dashboard · Voice (NEW in v4.0) — modul Zeline Zenith (sumber: zeline-zenith-z78).
...
Agent numbuhin kemampuannya sendiri — tapi lewat proposal (z32/frozen-paths), operator yang acc + re-lock.
...
# serve dari VPS (z3/z10). KASIH AUTH, jangan public polos.
```
...
Dua arah: lo ngomong, agent jawab suara. Lengkapin voice input z16.
...
- Planner/skill-forge/swarm decomposition pakai LLM via `model_registry` (z8/v4.0) — `add model` dulu kalau cascade kosong.

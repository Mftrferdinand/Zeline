#!/usr/bin/env python3
"""
tools/team_auth.py — Cryptographic Team Authentication (Zeline Zenith)
═══════════════════════════════════════════════════════════════════════
...
# ─── Challenge format ───
CHALLENGE_PREFIX = "Zeline Zenith-V7-AUTH"
...
class TeamAuth:
    """
    Cryptographic team authentication for Zeline Zenith.
    ...
    def generate_challenge(self, scope: str = "auth",
        ...
        The challenge follows the format:
          Zeline Zenith-V7-AUTH:{timestamp}:{nonce}

        For treasury operations, additional context is embedded:
          Zeline Zenith-V7-AUTH:{timestamp}:{nonce}:{scope}

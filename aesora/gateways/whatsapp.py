"""Gateway WhatsApp Aesora lewat bridge Baileys (Node.js).
...
BRIDGE_SOURCE = r'''/* Aesora WhatsApp Baileys bridge. Generated by Aesora. */
...
async function startSocket() {
  ...
  sock = makeWASocket({
    auth: state,
    browser: Browsers.ubuntu('Aesora'),

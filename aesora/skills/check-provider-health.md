...
> Prosedur generik untuk mendiagnosis provider OpenAI-compatible saat Aesora mendapat error 401, 403, 410, 429, atau 5xx.
...
5. Jika model gagal sementara endpoint sehat, pilih model yang tersedia pada provider tersebut dan update lewat `aesora setup`.
